			...
			<div data-custom-class="body">
				<div align="center" style={{ textAlign: "left" }}>
									...
									>
										<strong>
											<span style={{ lineHeight: "22.5px", fontSize: 26 }}>
												...
												LICENCE <bdt className="else-block" />
												AGREEMENT
											</span>
										</strong>
									</div>
							...
							>
								<span style={{ fontSize: "11pt", lineHeight: "16.8667px" }}>
									...
									<bdt className="question">
										<strong>
											<span data-custom-class="body_text">May 22, 2023</span>
										</strong>
									</bdt>
								</span>
							</div>
					...
					>
						...
						>
							...
							>
								...
								at
								<bdt className="question">CO RamGopal Agrawal</bdt>,
								<span
									style={{
										fontSize: "11.0pt",
										lineHeight: "115%",
								...
								>
									<bdt className="block-component" />
									<bdt className="question">dawa bazar, tandon bagicha</bdt>
									,
									<bdt className="statement-end-if-in-editor" />
									<bdt className="question">Damoh</bdt>
									,
									<bdt className="block-component" />
									<bdt className="question">Madhya Pradesh </bdt>
									<bdt className="statement-end-if-in-editor" />
									<bdt className="question">470661</bdt>
					...
					>
						...
						>
							...
							>
								...
								Licence
								<bdt className="else-block" />
								Agreement), You indicate that You agree to be bound by all of
					...
					>
						...
						>
							...
							>
								...
								, not the Services, is solely responsible for the Licensed
					...
					>
								...
								<span style={{ fontSize: 15 }}>
									<bdt data-type="body">
										...
										>
											...
											Licence
											<bdt className="else-block" />
											Agreement may not provide for usage rules for the Licensed
						...
						>
							<bdt className="block-component" />
							<a data-custom-class="link" href="#support">
					...
					>
						...
						>
							...
							>
								...
								<bdt className="else-block" />) is a piece of software created
								to
								<bdt className="question">
									Practice chess tactics to improve your ratings in Chess.
								</bdt>
								— and
								<bdt className="block-component" />
								customised
								...
								<bdt className="block-component" />
								mobile devices (
								<bdt className="block-component" />'<strong>D</strong>
								<strong>evices</strong>'
								<bdt className="else-block" />
								). It is used to
								<bdt className="question">Play Chess Puzzles</bdt>
								.
								<bdt className="block-component" />
							</span>
						</div>
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		licence
																		<bdt className="else-block" />
																		to install and use the Licensed Application
																		on any Devices that You (End-User) own or
																		control and as permitted by the Usage Rules,
																		with the exception that such Licensed
																		Application may be accessed and used by
																		other accounts associated with You
																		(End-User, The Purchaser) via Family Sharing
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		Application provided by Licensor that
																		replace, repair, and/or supplement the first
																		Licensed Application, unless a separate
																		<bdt className="block-component" />
																		licence
																		<bdt className="else-block" />
																		is provided for such update, in which case
																		the terms of that new
																		<bdt className="block-component" />
																		licence
																		<bdt className="else-block" />
																		will govern.
														...
														<bdt data-type="conditional-block">
															<bdt data-type="body">
																...
																>
																	...
																	Application available to third parties (unless
																	to the degree allowed by the Usage Rules, and
																	with
																	<bdt className="question">
																		Appmeito Technologies Private Limited
																	</bdt>
																	's prior written consent), sell, rent, lend,
																	lease or otherwise redistribute the Licensed
																	Application.
																	<span style={{ fontSize: 15 }}>
																		<span
																			style={{
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		source code of the Licensed Application, or
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		create and store copies only on devices that
																		You own or control for backup keeping under
																		the terms of this
																		<bdt className="block-component" />
																		licence
																		<bdt className="else-block" />
																		, the Usage Rules, and any other terms and
																		conditions that apply to the device or
																		software used. You may not remove any
																		intellectual property notices. You
																		acknowledge that no
																		<bdt className="block-component" />
																		unauthorised
																		<bdt className="else-block" />
																		third parties may gain access to these
																		copies at any time. If you sell your Devices
																		to a third party, you must remove the
																		Licensed Application from the Devices before
																		doing so.
																		<span
																			style={{
																				fontSize: "11pt",
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		third-party terms. When using the Licensed
																		Application, You must ensure that You comply
																		with applicable third-party terms and
																		conditions.
																		<span
																			style={{
																				fontSize: "11pt",
					...
					>
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		modified/new versions of the firmware and
																		new hardware. You are not granted rights to
													...
													<bdt data-type="body">
														...
														>
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<font color="#595959">
																		<span style={{ fontSize: 15 }}>4.2 </span>
																	</font>
																	<span style={{ fontSize: 15 }}>
																		<bdt className="question">
																			Appmeito Technologies Private Limited
																	...
																	<font color="#595959">
																		<span style={{ fontSize: 15 }}>
																			...
																			Services have no obligation whatsoever to
													...
													<span style={{ color: "rgb(89, 89, 89)" }}>
														...
														>
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		You acknowledge that Licensor will be able
																		to access and adjust Your downloaded
																		Licensed Application content and Your
																		personal information, and that Licensor's
																		use of such material and information is
																		subject to Your legal agreements with
																		Licensor and Licensor's privacy policy
																		<bdt className="block-component" />:{" "}
																		<bdt className="question">
																			<a
																				href="https://www.termsfeed.com/live/0dc75106-fb8b-4999-8249-c3fde3f48221"
																				target="_blank"
																				data-custom-class="link"
																			>
																				https://www.termsfeed.com/live/0dc75106-fb8b-4999-8249-c3fde3f48221
																			</a>
																		</bdt>
																		<bdt className="block-component" />.
																	</span>
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		users of the Licensed Application and
																		through third-party websites or
																		applications. As such, any Contributions you
																		transmit may be treated in accordance with
																		the Licensed Application Privacy Policy.
						...
						>
							<span style={{ fontSize: 15 }}>
								...
								<bdt className="block-component" />
								licences
								<bdt className="else-block" />, rights, consents, releases, and
								permissions to use and to <bdt className="block-component" />
								authorise
								<bdt className="else-block" /> us, the Licensed Application, and
								other users of the Licensed Application to use your
								Contributions in any manner contemplated by the Licensed
								Application and this <bdt className="block-component" />
								Licence
								<bdt className="else-block" /> Agreement.
							</span>
						</div>
						<div
							className="MsoNormal"
						...
						>
							<span style={{ fontSize: 15 }}>
								...
								<bdt className="block-component" />
								Licence
								<bdt className="else-block" /> Agreement, or any applicable law
								or regulation.
							</span>
						</div>
						<div
						...
						>
							<span style={{ fontSize: 15 }}>
								...
								foregoing violates this <bdt className="block-component" />
								Licence
								<bdt className="else-block" /> Agreement and may result in,
															...
															<bdt data-type="conditional-block">
																<bdt data-type="body">
																	<span style={{ color: "rgb(89, 89, 89)" }}>
																		...
																		8
																		<bdt className="else-block" />
																		.1 Licensor takes no accountability or
																		responsibility for any damages caused due to
																		a breach of duties according to Section 2 of
																		this
																		<bdt className="block-component" />
																		Licence
																		<bdt className="else-block" />
																		Agreement. To avoid data loss, You are
																		required to make use of backup functions of
																		the Licensed Application to the extent
																		allowed by applicable third-party terms and
																		conditions of use. You are aware that in
																		case of alterations or manipulations of the
																		Licensed Application, You will not have
													...
													<bdt data-type="conditional-block">
														<bdt data-type="body">
															<span style={{ color: "rgb(89, 89, 89)" }}>
																...
																combined or installed with inappropriate
																hardware or software, used with inappropriate
																accessories, regardless if by Yourself or by
																third parties, or if there are any other reasons
																outside of
																<bdt className="question">
																	Appmeito Technologies Private Limited
																</bdt>
													...
													<bdt data-type="conditional-block">
														<bdt data-type="body">
															<span style={{ color: "rgb(89, 89, 89)" }}>
																...
																consideration and further investigated if it has
																been emailed within a period of
													...
													<bdt data-type="conditional-block">
														<bdt data-type="body">
															<span style={{ color: "rgb(89, 89, 89)" }}>
																...
																reserves a choice to remedy the situation either
																by means of solving the defect or substitute
																delivery.
															</span>
														</bdt>
													</bdt>
							...
							<bdt data-type="body">
								...
								>
									...
									>
										...
										purchase price will be refunded to You. To the maximum
										extent permitted by applicable law, the Services Store
										Operator will have no other warranty obligation whatsoever
										with respect to the Licensed Application, and any other
							...
							<bdt data-type="body">
								...
								>
									...
									>
										...
										<bdt className="else-block" />
										country; and that You are not listed on any US Government
				...
				<div style={{ textAlign: "left" }}>
					...
					>
						...
						>
							...
							<bdt className="block-component" />
							'Instructions for Minimum Terms of Developer's End-User Licence
							Agreement',
							<bdt className="else-block" />
							<bdt className="block-component" />
							Apple's
							...
							Licence
							<bdt className="else-block" />
							Agreement and — upon Your acceptance of the terms and conditions
							of this
							<bdt className="block-component" />
							Licence
							<bdt className="else-block" />
							...
							right) to enforce this End User
							<bdt className="block-component" />
							Licence
							<bdt className="else-block" />
				...
				<div style={{ textAlign: "left" }}>
					...
					>
						...
						>
							...
							claim that the Licensed Application or the End-User's possession
							and use of that Licensed Application infringes on the third
							...
							<bdt className="block-component" />
							defence
							<bdt className="else-block" />, settlement, and discharge or any
								...
								<bdt data-type="body">
									...
									>
										...
										>
											...
											not be affected. Invalid terms will be replaced by valid
											ones formulated in a way that will achieve the primary
											purpose.
										</span>
									</div>
								</bdt>
								...
								<bdt data-type="body">
									...
									>
										...
										>
											...
											Collateral agreements, changes and amendments are only
											valid if laid down in writing. The preceding clause can
