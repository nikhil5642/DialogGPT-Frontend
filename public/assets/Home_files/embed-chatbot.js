(function () {
	...
	chatBubble.innerHTML = `<img src="https://dialogpt.io/assets/chat_icon.png" loading="lazy" style="height: ${smallIconSize}; width: ${smallIconSize};">`;
	...
	function handleChatBubbleClick() {
		...
		if (iframe.style.display === "none" || iframe.style.display === "") {
			...
			chatBubble.style.backgroundColor = bgColor;
			chatBubble.style.backgroundColor = bgColor;
			chatBubble.innerHTML = `<img src="https://dialogpt.io/assets/down_arrow_white.png" loading="lazy" style="height: 32px; width: 32px;">`; // Down arrow icon when iframe is visible
		} else {
